...
import com.kuafuai.common.exception.file.FileNameLengthLimitExceededException;
import com.kuafuai.common.exception.file.FileSizeLimitExceededException;
import com.kuafuai.common.exception.file.InvalidExtensionException;
import com.kuafuai.common.util.DateUtils;
import com.kuafuai.common.util.Seq;
...
public class FileUploadUtils {
    ...
    public static String extractFilename(String formatter) {

        return StringUtils.format("{}/{}_{}.{}", DateUtils.datePath(),
                FilenameUtils.getBaseName(UUID.randomUUID().toString().replace("-", "")), Seq.getId(Seq.uploadSeqType), formatter);
    }
